export const maharashtraData = {
  ...
  "Amravati": ["Achalpur", "Chandur Bazar", "Chandur Railway", "Daryapur", "Dhamangaon Railway", "Morshi", "Nandgaon Khandeshwar", "Teosa", "Warud"],
  "Aurangabad": ["Aurangabad", "Gangapur", "Kannad", "Khuldabad", "Paithan", "Phulambhri", "Sillod", "Vaijapur"],
  ...
  "Kolhapur": ["Ajra", "Bhudargad", "Chandgad", "Gadhinglaj", "Hatkanangale", "Karvir", "Panhala", "Radhanagari", "Shahuwadi", "Shirol"],
  ...
  "Pune": ["Ambegaon", "Baramati", "Bhor", "Daund", "Haveli", "Indapur", "Junnar", "Khed", "Mulshi", "Maval", "Purandar", "Shirur", "Velhe", "Pune City"],
  ...
  "Sangli": ["Atpadi", "Jat", "Kavathe mahankal", "Khanapur", "Miraj", "Palus", "Shirala", "Tasgaon", "Walwa-Islampur", "Walwa"],
  ...
  "Washim": ["Karanja", "Mangrulpir", "Malegaon Jh", "Manora", "Risod", "Washim"],
